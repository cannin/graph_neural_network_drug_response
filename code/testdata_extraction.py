...
def extractTestData(SMILES, PubChemID, nci60Act_ccle):

    # Read original train data
    train = pd.read_table(
        '../data/drugcell_train.txt',
        header=None
    )
    ...
    nci60Act = nci60Act.loc[
        sorted(list(set(smiles.index) & set(nci60Act.index)))
    ][
...
if __name__ == '__main__':
    ...
    if len(args) == 4:
        ...
        print('Argument Error: Requires 3 arguments, SMILES, PubChemID and nci60Act_ccle')
