...
def predict_dcell(
	predict, cell2id, drug2id, genotype, fingerprint, model_file,
	hidden_folder, result_file, batch_size=1000
	):

	predict_data, _, _ = prepare_predict_data(
		predict, cell2id, drug2id
	)
